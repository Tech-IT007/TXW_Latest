...
@Component({
  selector: 'app-verfied-reset-password',
  templateUrl: './verfied-reset-password.page.html',
  styleUrls: ['./verfied-reset-password.page.scss'],
})
export class VerfiedResetPasswordPage implements OnInit {
...
tea = true
  ...
  acountbranchno: string;
  acountbranchmanager: string;
...
this.acountbranchno = localStorage.getItem('accountBranchNo');
this.acountbranchmanager = localStorage.getItem('accountBranchManager');
