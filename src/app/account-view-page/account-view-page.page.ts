...
@Component({
  ...
  templateUrl: './account-view-page.page.html',
  styleUrls: ['./account-view-page.page.scss'],
})
export class AccountViewPagePage implements OnInit {
...
route_to_profile_answer_screen(BookingID) {
  ...
  this.router.navigate(['account-view-details'], navigationExtras);
