...
@Component({
  selector: 'app-state-transfer-money',
  templateUrl: './state-transfer-money.page.html',
  styleUrls: ['./state-transfer-money.page.scss'],
})
export class StateTransferMoneyPage implements OnInit {
historyModal=false;
selectedHistory:any[]=[];
  impact: any[] = [];
  show = false;
  ...
  dataToSend = {
    PaymentID: localStorage.getItem("State_payment_id"),
