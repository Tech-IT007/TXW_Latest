...
@Component({
  selector: 'app-ppm-account-booking',
  templateUrl: './ppm-account-booking.page.html',
  styleUrls: ['./ppm-account-booking.page.scss'],
})
export class PpmAccountBookingPage implements OnInit {
  showForm = false;
...
// xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx    
  ...
  ngOnInit() {
    ...
    this.advance_cost()
    this.bookingdata.TicketStatus= "noida"
...
if(window){
 ...
 this.ngxService.start();
    ...
    return this.http.post(url, this.bookingdata).subscribe((data) => {
      ...
      this.router.navigate(["ppm-account-branch"], navigationExtras)
      this.ngxService.stop();
    });
