...
@Component({
  selector: 'app-quotation-approve-all-tickets',
  templateUrl: './quotation-approve-all-tickets.page.html',
  styleUrls: ['./quotation-approve-all-tickets.page.scss'],
})
export class QuotationApproveAllTicketsPage {
...
setApprovalStatus() {
  ...
  if (this.IsFinanceApprove === "Yes") {
    ...
    this.approvel.IsFinanceApprove = "Yes";
    this.approvel.IsStateApprove = "No";

    this.approvel.QuotationStatus = [
      "Quote Approved By State"
    ];
  }
  ...
  // 👉 State Approver
    ...
    this.approvel.IsStateApprove = "Yes";

    this.approvel.QuotationStatus = [
      "Quote Sent Approval Pending"
    ];
  }
  ...
  viewDetails(id: string) {
    ...
    this.router.navigate(['/account-approvel-details-by-id']);
  }
