...
@Component 
({
  selector: 'app-city-submit-closer',
  templateUrl: './city-submit-closer.page.html',
  styleUrls: ['./city-submit-closer.page.scss'],
})
export class CitySubmitCloserPage implements OnInit {
  showForm = false;
