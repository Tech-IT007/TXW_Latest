...
@Component({
  selector: 'app-account-site-vist-all-data',
  templateUrl: './account-site-vist-all-data.page.html',
  styleUrls: ['./account-site-vist-all-data.page.scss'],
})
export class AccountSiteVistAllDataPage implements OnInit {
  SiteVisitID: any;
  users: any;
  obj: any;
  Status: any;
