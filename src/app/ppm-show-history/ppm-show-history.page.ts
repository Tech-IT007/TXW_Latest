...
@Component({
  selector: 'app-ppm-show-history',
  templateUrl: './ppm-show-history.page.html',
  styleUrls: ['./ppm-show-history.page.scss'],
 providers: [DatePipe]
})
export class PpmShowHistoryPage implements OnInit {
  ...
  assets_id = {
    asset_id: localStorage.getItem('PPM_history_asseta_id')
  };
