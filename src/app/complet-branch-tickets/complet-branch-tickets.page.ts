...
@Component({
  selector: 'app-complet-branch-tickets',
  templateUrl: './complet-branch-tickets.page.html',
  styleUrls: ['./complet-branch-tickets.page.scss'],
})
export class CompletBranchTicketsPage implements OnInit {
  BookingID: any;
  role: any
  city_lead =false
  handleRefresh(event) {
  ...
  runHttp() {
    ...
    setTimeout(() => {
      ...
      this.router.navigate(['/complet-branch-tickets']);
    }, 1000); //
    ...
    var url = "https://techxpertindia.in/api/get_complete_branch_account_manager_tickets.php "
