...
@Component({
  selector: 'app-account-approvel-details-by-id',
  templateUrl: './account-approvel-details-by-id.page.html',
  styleUrls: ['./account-approvel-details-by-id.page.scss'],
})
export class AccountApprovelDetailsByIdPage implements OnInit {
