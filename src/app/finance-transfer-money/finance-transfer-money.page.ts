...
@Component({
  selector: 'app-finance-transfer-money',
  templateUrl: './finance-transfer-money.page.html',
  styleUrls: ['./finance-transfer-money.page.scss'],
})
export class FinanceTransferMoneyPage implements OnInit {
historyModal=false;
selectedHistory:any[]=[];
  impact: any[] = [];
  show = false;
  ...
  dataToSend = {
    PaymentID: localStorage.getItem("finance_payment_id"),
