...
@Component({
  selector: 'app-ppm-hvac-form',
  templateUrl: './ppm-hvac-form.page.html',
  styleUrls: ['./ppm-hvac-form.page.scss'],
})
export class PpmHvacFormPage implements OnInit {
...
all_services_report(){
  ...
  return this.http.post(url , this.user_id).subscribe((data)=>{
   ...
   this.hvac_report = data
    this.hvac_report = this.hvac_report.hvac_data

    console.log( "reprt:",this.hvac_report)
  })
}
