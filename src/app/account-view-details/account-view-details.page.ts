...
@Component({
  selector: 'app-account-view-details',
  templateUrl: './account-view-details.page.html',
  styleUrls: ['./account-view-details.page.scss'],
})
export class AccountViewDetailsPage implements OnInit {
  showForm = false;
