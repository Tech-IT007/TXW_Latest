...
@Component({
  selector: 'app-technicean-complete-visit',
  templateUrl: './technicean-complete-visit.page.html',
  styleUrls: ['./technicean-complete-visit.page.scss'],
})
export class TechniceanCompleteVisitPage implements OnInit {
