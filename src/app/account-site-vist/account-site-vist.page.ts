...
@Component({
  selector: 'app-account-site-vist',
  templateUrl: './account-site-vist.page.html',
  styleUrls: ['./account-site-vist.page.scss'],
})
export class AccountSiteVistPage implements OnInit {
