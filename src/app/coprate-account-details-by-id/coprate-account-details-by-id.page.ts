...
@Component({
  selector: 'app-coprate-account-details-by-id',
  templateUrl: './coprate-account-details-by-id.page.html',
  styleUrls: ['./coprate-account-details-by-id.page.scss'],
})
export class CoprateAccountDetailsByIdPage implements OnInit {
  showForm = false;
